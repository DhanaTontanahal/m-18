...
PROMPT = PROMPT = PromptTemplate(
    ...
    Based on the context, answer the question concisely. Your response must:
    1. Include the answer in the 'answer' field.
    2. Provide a 'videoLink' field with the relevant video link (use a placeholder if not available).
    3. Always end with "Do you need more help?".

    Return the response as a JSON object with the following format:
    {{
        "answer": "<Your answer>",
        "videoLink": "<Relevant video link>",
        "additionalHelp": "Do you need more help?"
    }}
    If the context contains generic text without specifying exact context , ask relevant questions to the user or
    If the context does not contain relevant information, the 'answer' field should be: "I don’t have enough information to answer that question." and the 'videoLink' field should be: "https://www.youtube.com/watch?v=wCCxjd24sRs".
    """,
